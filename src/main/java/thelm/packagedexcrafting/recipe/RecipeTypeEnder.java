...
public class RecipeTypeEnder implements IRecipeType {

	public static final RecipeTypeEnder INSTANCE = new RecipeTypeEnder();
	public static final ResourceLocation NAME = new ResourceLocation("packagedexcrafting:ender");
	public static final IntSet SLOTS;
	public static final List<String> CATEGORIES = Collections.singletonList("extendedcrafting:ender_crafting");
	...
	public String getLocalizedName() {
		return I18n.translateToLocal("recipe.packagedexcrafting.ender");
	}

	@Override
	public String getLocalizedNameShort() {
		return I18n.translateToLocal("recipe.packagedexcrafting.ender.short");
	}

	@Override
	public IRecipeInfo getNewRecipeInfo() {
		return new RecipeInfoEnder();
	}
	...
	public Object getRepresentation() {
		return new ItemStack(ModBlocks.blockEnderCrafter);
	}
