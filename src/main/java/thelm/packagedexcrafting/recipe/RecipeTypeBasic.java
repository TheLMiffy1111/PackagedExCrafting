...
public class RecipeTypeBasic implements IRecipeType {

	public static final RecipeTypeBasic INSTANCE = new RecipeTypeBasic();
	public static final ResourceLocation NAME = new ResourceLocation("packagedexcrafting:basic");
	public static final IntSet SLOTS;
	public static final List<String> CATEGORIES = Collections.singletonList("extendedcrafting:table_crafting_3x3");
	...
	public String getLocalizedName() {
		return I18n.translateToLocal("recipe.packagedexcrafting.basic");
	}

	@Override
	public String getLocalizedNameShort() {
		return I18n.translateToLocal("recipe.packagedexcrafting.basic.short");
	}

	@Override
	public IRecipeInfo getNewRecipeInfo() {
		return new RecipeInfoBasic();
	}
