...
public class BasicCrafterScreen extends BaseScreen<BasicCrafterContainer> {

	public static final ResourceLocation BACKGROUND = new ResourceLocation("packagedexcrafting:textures/gui/basic_crafter.png");

	public BasicCrafterScreen(BasicCrafterContainer container, PlayerInventory playerInventory, ITextComponent title) {
