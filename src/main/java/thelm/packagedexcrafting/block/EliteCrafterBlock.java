...
public class EliteCrafterBlock extends BaseBlock {
	...
	public static final Item ITEM_INSTANCE = new BlockItem(INSTANCE, new Item.Properties().group(PackagedExCrafting.ITEM_GROUP)).setRegistryName("packagedexcrafting:elite_crafter");
