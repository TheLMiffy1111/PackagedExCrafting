...
public class HostHelperTileEliteCrafter extends HostHelperTile<TileEliteCrafter> {

	public HostHelperTileEliteCrafter(TileEliteCrafter tile) {
		super(tile);
	...
	public void ejectItem() {
		...
		int endIndex = tile.isWorking ? 49 : 0;
